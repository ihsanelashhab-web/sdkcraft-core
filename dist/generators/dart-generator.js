...
exports.generateDartSDK = generateDartSDK;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
function generateDartSDK(spec, outputDir) {
    ...
    spec.endpoints.forEach((endpoint) => {
        ...
        if (queryParams.length > 0)
            args.push(`Map<String, String>? params`);
        if (endpoint.requestBody)
            args.push(`Map<String, dynamic>? body`);
    ...
    const outputPath = path_1.default.join(outputDir, "sdk.dart");
